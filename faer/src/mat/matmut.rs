    ...
    MatMut<'a, T, Rows, Cols, RStride, CStride>
{
    ...
    {
        <MatMut<'a, T, Rows, Cols, RStride, CStride> as MatIndex<RowRange, ColRange>>::get(
            self, row, col,
        )
    }
    ...
    {
        unsafe {
            <MatMut<'a, T, Rows, Cols, RStride, CStride> as MatIndex<RowRange, ColRange>>::get_unchecked(
                self, row, col,
            )
        }
    }
