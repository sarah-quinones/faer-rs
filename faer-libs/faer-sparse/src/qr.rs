...
use faer_core::{
    ...
    temp_mat_req, temp_mat_uninit, unzipped, zipped, Conj, MatMut, Parallelism,
};
use faer_entity::*;
use reborrow::*;
...
pub mod supernodal {
    ...
    #[derive(Debug)]
    pub struct SupernodalQrRef<'a, I, E: Entity> {
    ...
    impl<I, E: Entity> Clone for SupernodalQrRef<'_, I, E> {
        #[inline]
        fn clone(&self) -> Self {
            *self
        }
    ...
    pub(crate) fn factorize_supernodal_numeric_qr_impl<I: Index, E: ComplexField>(
        ...
        for s in 0..n_supernodes {
            ...
            let mut s_H = faer_core::mat::from_column_major_slice_mut::<'_, E>(
                s_H.into_inner(),
                s_h_row_full_end - s_h_row_begin,
            ...
            while child_ >= I::Signed::truncate(0) {
                ...
                let c_H = faer_core::mat::from_column_major_slice::<'_, E>(
                    c_H.into_inner(),
...
pub fn factorize_symbolic_qr<I: Index>(
    ...
    Size::with2(m, n, |M, N| {
            ...
            && threshold != SupernodalThreshold::FORCE_SUPERNODAL
        {
            ...
            if flops / nnz > threshold.0 * crate::QR_SUPERNODAL_RATIO_FACTOR {
                threshold = SupernodalThreshold::FORCE_SUPERNODAL;
            } else {
