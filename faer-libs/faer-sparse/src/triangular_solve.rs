...
pub fn solve_lower_triangular_in_place<I: Index, E: ComplexField>(
    ...
    faer_core::constrained::Size::with2(
        rhs.nrows(),
        rhs.ncols(),
        #[inline(always)]
        |N, K| {
            let mut x = faer_core::constrained::MatMut::new(rhs, N, K);
            let l = faer_core::constrained::sparse::SparseColMatRef::new(l, N, N);
...
pub fn solve_upper_triangular_in_place<I: Index, E: ComplexField>(
    ...
    faer_core::constrained::Size::with2(
        ...
        |N, K| {
            let mut x = faer_core::constrained::MatMut::new(rhs, N, K);
            let u = faer_core::constrained::sparse::SparseColMatRef::new(u, N, N);
