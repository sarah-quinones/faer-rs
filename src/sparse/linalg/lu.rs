...
use super::{
    ...
    nomem, try_zeroed, FaerError, Index, LuError, SupernodalThreshold, SymbolicSparseColMatRef,
...
pub mod supernodal {
    ...
    impl<I: Index, E: Entity> SupernodalLu<I, E> {
            ...
            E: ComplexField,
        {
            ...
            for s in 0..lu.nsupernodes {
                ...
                let L = crate::mat::from_column_major_slice_generic::<'_, E, _, _>(
                    L.into_inner(),
                    s_row_index_count,
                    s_size,
                );
            ...
            E: ComplexField,
        {
            ...
            for s in (0..lu.nsupernodes).rev() {
                ...
                let U_right = crate::mat::from_column_major_slice_generic::<'_, E, _, _>(
                    U.into_inner(),
                    s_col_index_count,
                    s_size,
                )
    ...
    pub fn factorize_supernodal_numeric_lu<I: Index, E: ComplexField>(
        ...
        for s in 0..n_supernodes {
            ...
            crate::linalg::lu::partial_pivoting::compute::lu_in_place_impl(
                s_L.rb_mut(),
                0,
                s_size,
                transpositions,
            ...
            let s_U = lu
                ...
                .as_slice_mut()
                .subslice(lu.ut_col_ptr_for_val[s].zx()..lu.ut_col_ptr_for_val[s + 1].zx());
            let mut s_U = crate::mat::from_column_major_slice_mut_generic::<'_, E, _, _>(
                s_U.into_inner(),
                s_col_index_count,
                s_size,
            )
...
pub mod simplicial {
    ...
    pub fn factorize_simplicial_numeric_lu_req<I: Index, E: Entity>(
        ...
        let val = crate::sparse::linalg::make_raw_req::<E>(nrows)?;
        let _ = ncols;
    ...
    pub fn factorize_simplicial_numeric_lu<I: Index, E: ComplexField>(
        ...
        let (mut x, stack) = crate::sparse::linalg::make_raw::<E>(m, stack);
        let (marked, stack) = stack.make_raw::<I>(m);
...
mod tests {
    ...
    fn test_numeric_lu_multifrontal() {
        type E = crate::complex_native::c64;
        ...
        let etree = {
            ...
            crate::sparse::linalg::qr::postorder(
                &mut post,
                etree,
        ...
        let symbolic =
            crate::sparse::linalg::lu::supernodal::factorize_supernodal_symbolic_lu::<usize>(
                A.symbolic(),
                Some(col_perm),
                &min_col,
                etree,
                ...
                crate::sparse::linalg::SymbolicSupernodalParams {
